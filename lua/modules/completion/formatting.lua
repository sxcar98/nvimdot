...
function M.format_filter(clients)
    return vim.tbl_filter(function(client)
        ...
        if status_ok and formatting_supported and client.name == "clangd" then
            return "clang-format"
        elseif status_ok and formatting_supported and client.name == "sumneko_lua" then
            return "stylua"
        elseif client.name ~= "sumneko_lua" and client.name ~= "clangd" then
